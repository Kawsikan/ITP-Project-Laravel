...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <br>
    <h3 class="text-center">New Catering Orders</h3>
    <div class="row">
        <div class="col-sm-8">
            <a href="/show-packages" class="btn btn-primary" title="Customer Menu">Customer Menu</a>
            <a href="/corder-report" class="btn btn-dark" title="View report">Report</a>
            <a href="/download-corder" class="btn btn-danger" title="Download report">Download</a>
            <a href="/catercompleted-orders" class="btn btn-warning" title="Completed">Completed  <span class="badge badge-light">{{$count}}</span>  </a>
