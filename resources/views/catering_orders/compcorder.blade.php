...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <br>
    <h3 class="text-center">Catering Order Completed</h3>
    <div class="row">
        <div class="col-sm-8">
            ...
            <a href="/show_corders" class="btn btn-warning" title="New order">New orders <span class="badge badge-light">{{$count}}</span> </a>
