        ...
        <div class="row">
            <div class="col-sm-8 offset-sm-3">
                ...
                <a href="/show_corders" class="btn btn-primary">
                    ...
                    <div>
                          <center><form action="/catercompleted/{{$corders->id}}" method = "GET">
                          <button style="float: right;" class = "btn btn-success" type = "submit" >Completed</button>
                          </form></center>
                    </div>
                <br>
                    ...
                    <form>
                        <div class="col-sm-8 offset-sm-3">
                            ...
                            <div class="form-row">
                                ...
                                <input readonly id="address" class="form-control col-sm-6" name="address"
                            ...
                            <div class="form-row">
                                ...
                                <input readonly id="location" class="form-control col-sm-6" name="location"
