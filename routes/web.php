 ...
 * author : Kawsikan
 */
Route::get('/catercompleted/{id}','CustomerController@markAsCCompleted');
Route::get('/catercompleted-orders','CustomerController@getCompletedCOrders');
...
Route::get('/search-corder','Catering_orderController@searchcorder');
